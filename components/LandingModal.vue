<template>
  <div v-if="contentReady" class="landing-modal" :class="phaseClasses">
    <div class="heading-container">
      <h1 class="landing-heading font--stylized">James Lawton</h1>
      <h2 class="landing-subtitle">Blockchain
        <span class="separator">/</span> Artificial Intelligence</h2>
    </div>
    ...
    <div class="modal-links">
      <ul class="links-default">
        ...
        <li>
          <a class="link--stylized" @click.prevent="gotoInfo" href="/info">Info &amp; Projects</a>
        </li>
      </ul>
    </div>
  </div>
